...
func about(w http.ResponseWriter, r *http.Request) {
	aboutContent := []string{
		"I started my computer journey in 1998.",
		...
		"I didn't have Internet access like we do today and when I did, it was a dial up connection to an Internet Service Provider. Something known as PPP. Have you heard about it?",
		"Sometimes I asked friends or people from the computer industry from my home town for help or to lend me some CD-ROMs, books, magazines, etc.",
		"That was how I could have access to some computer related content at that time.",
		"One year had gone by and I heard about Linux. It sounded like a very nice operating system. So, I decided I will be good at it.",
		"Once more I asked a friend to help me. That friend lend me a CD-ROM with a bundled Slackware 3.4 installer.",
		...
		"My dream at that time was to get a job as a C programmer. I got one, well not as a C programmer, but as a PHP programmer. What could I do? I decided to face the challenge. At my very first day at the new company, my boss told me that I needed to install a Linux server with an Apache and MySQL server first in order to start programming.",
		"So I did it, but when I was just about to be \"promoted\" as a programmer, I had to quit that job and started another one as a kind of Linux Network Administrator.",
		...
		"I would say that working in that role I had an opportunity to really learn a lot about Linux, computer's network and of course, C programming.",
